...
/**
 * Tests for the InputDevices table
 *
...
class InputDevicesTest extends AbstractTestCase
{
    ...
    public function testHydrator()
    {
        ...
        $this->assertEquals('Comment', $map->hydrate('description'));
        $this->assertEquals('Interface', $map->hydrate('interface'));
        ...
        $this->assertEquals('description', $map->extract('Comment'));
        $this->assertEquals('interface', $map->extract('Interface'));
