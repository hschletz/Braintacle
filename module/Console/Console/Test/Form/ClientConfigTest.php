...
class ClientConfigTest extends \Console\Test\AbstractFormTest
{
    ...
    {
        $this->_client = $this->getMockBuilder('Model\Client\Client')->disableOriginalConstructor()->getMock();
    ...
    public function testInputFilterAgentValuesTooSmall()
    {
        ...
        $messages = array(
            'contactInterval' => array('callbackValue' => "The input is not greater or equal than '1'"),
            'inventoryInterval' => array('callbackValue' => "The input is not greater or equal than '-1'"),
        );
    ...
    public function testInputFilterDownloadValuesTooSmall()
    {
        ...
        $this->_form->setData($data);
        $this->assertFalse($this->_form->isValid());
        $message = array('callbackValue' => "The input is not greater or equal than '1'");
        $messages = array(
