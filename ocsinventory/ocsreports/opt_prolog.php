...
ligne("PROLOG_FREQ",$l->g(724),'radio',$champ_value,array('HIDDEN'=>'CUSTOM','HIDDEN_VALUE'=> isset ($optvalue) ? check_param ($optvalue, "PROLOG_FREQ") : NULL,'END'=>$l->g(730),'JAVASCRIPT'=>$numeric));
fin_tab($form_name);
