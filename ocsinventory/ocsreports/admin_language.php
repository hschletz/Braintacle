...
if (check_param ($_POST, 'ok_for_change') == "OK"){
	$new_file=str_replace("\\", "", $_POST['modif_txt']);
	$handle = fopen ("languages/" . check_param ($_POST, "langue_modif", "[a-z]*") . ".txt", "w"); // maybe a bit too restrictive...
...
$contenu_du_fichier_ref = NULL;
$contenu_du_fichier_modif = NULL;
if (check_param ($_POST, "langue_ref", "[a-z]*")){ // maybe a bit too restrictive...
...
if (check_param ($_POST, "langue_modif", "[a-z]*")){ // maybe a bit too restrictive...
