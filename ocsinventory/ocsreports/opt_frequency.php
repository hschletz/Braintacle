...
debut_tab(array('CELLSPACING'=>'5',
					...
					'BGCOLOR'=>'#C7D9F5',
					'BORDERCOLOR'=>'#9894B5'));
if (isset ($optvalue) and $optvalue['FREQUENCY'] == 0 and isset($optvalue['FREQUENCY']))
$optvalueselected = 'ALWAYS';
elseif(isset ($optvalue) and $optvalue['FREQUENCY'] == -1)
...
ligne("FREQUENCY",$l->g(494),'radio',$champ_value,array('HIDDEN'=>'CUSTOM','HIDDEN_VALUE'=> isset ($optvalue) ? $optvalue['FREQUENCY'] : NULL,'END'=>$l->g(496),'JAVASCRIPT'=>$numeric));
fin_tab($form_name);
