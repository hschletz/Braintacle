...
require_once("$basePath/module/Database/Module.php");
$module = new \Database\Module;
\Zend\Loader\AutoloaderFactory::factory($module->getAutoloaderConfig());
require_once("$basePath/module/Model/Module.php");
$module = new \Model\Module;
\Zend\Loader\AutoloaderFactory::factory($module->getAutoloaderConfig());
require_once("$basePath/module/Export/Module.php");
$module = new \Export\Module;
\Zend\Loader\AutoloaderFactory::factory($module->getAutoloaderConfig());
